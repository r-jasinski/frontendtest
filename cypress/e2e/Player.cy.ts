...
describe('Player', () => {
  ...
  it('should have correct player image and name', () => {
    ...
    cy.get('.player img')
      ...
      .should('eq', 'src/assets/images/black_400.png')
  })
